...
export const IPC = {
  ...
  // colour that is not #rgb/#rrggbb is REPAIRED to its default. A malformed field must never be
  // why an alert shows nothing — but nothing unvalidated may reach a window that puts it in CSS.
