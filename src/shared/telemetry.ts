...
export const TELEMETRY_OVERLAY_KINDS = [
  ...
  'debuffs',
  // The alert-text lane (docs/plans/alert-text-overlays.md) — same closed-enum deploy order as
  // the two above: the ingest Lambda has to know this value before a client can send it.
  'alert'
] as const
